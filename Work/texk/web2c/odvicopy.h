...
int8odvicopy pcktsbyte AA((void));
...
void zpcktchar AA((boolean upd,integer ext,integer res));
...
void zoutchar AA((boolean upd,integer ext,integer res));
