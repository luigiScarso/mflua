...
maxcol=79;{:5}type{8:}ASCIIcode=32..126;
{:8}{9:}textfile=packed file of char;{:9}{20:}eightbits=0..255;
bytefile=packed file of eightbits;{:20}{36:}pixel=0..1;
{:36}var{10:}xord:array[char]of ASCIIcode;xchr:array[0..255]of char;
{:10}{21:}gffile:bytefile;{:21}{23:}curloc:integer;
{:23}{25:}wantsmnemonics:cinttype;wantspixels:cinttype;
{:25}{35:}m,n:integer;paintswitch:pixel;
...
'gftype: Need exactly one file argument.');usage('gftype');end;end;
...
if maxsubcol>=0 then{43:}begin writeln(stdout,
