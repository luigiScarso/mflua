...
{:36}{71:}widthpointer=0..maxwidths;
{:71}{77:}charoffset=negmaxchars..maxchars;charpointer=0..maxchars;
{:77}{80:}ftype=0..3;fontnumber=0..maxfonts;{:80}{84:}typeflag=0..31;
{:84}{117:}cmdpar=0..12;{:117}{120:}cmdcl=0..17;
{:120}{155:}vfstate=array[0..1,0..1]of boolean;{:155}{157:}vftype=0..4;
{:157}{193:}{[199:]pixvalue=-32767..32767;[:199]}
stackpointer=0..stacksize;stackindex=1..stacksize;
pair32=array[0..1]of integer;stackrecord=record hfield:integer;
vfield:integer;wxfield:pair32;yzfield:pair32;{[201:]hhfield:pixvalue;
vvfield:pixvalue;[:201]}end;{:193}{220:}recurpointer=0..maxrecursion;
{:220}var{17:}xord:array[ASCIIcode]of ASCIIcode;
...
fntextended:array[fontnumber]of boolean;{:82}{85:}curfnt:fontnumber;
curext:int24;curres:integer;curtype:typeflag;pcktext:int24;
pcktres:integer;pcktdup:boolean;pcktprev:pcktpointer;
pcktmmsg,pcktsmsg,pcktdmsg:int7;{:85}{91:}tfmfile:bytefile;
tfmext:pcktpointer;ofmext:pcktpointer;
{:91}{97:}tfmb0,tfmb1,tfmb2,tfmb3:eightbits;{:97}{101:}tfmconv:real;
{:101}{109:}dvifile:bytefile;dviloc:integer;fullname:^char;
{:109}{118:}dvipar:packed array[eightbits]of cmdpar;
{:118}{121:}dvicl:packed array[eightbits]of cmdcl;
{:121}{123:}dvicharcmd:array[boolean]of eightbits;
...
curparm:integer;curclass:cmdcl;{:125}{126:}curcp:charpointer;
curwp:widthpointer;curupd:boolean;curvdimen:integer;curhdimen:integer;
{:126}{129:}dviefnts:array[fontnumber]of integer;
dviifnts:array[fontnumber]of fontnumber;dvinf:fontnumber;
{:129}{135:}vffile:bytefile;vfloc:integer;vflimit:integer;
vfext:pcktpointer;ovfext:pcktpointer;vfcurfnt:fontnumber;
{:135}{143:}{104:}z:integer;alpha:integer;beta:int15;
{:104}{:143}{147:}vfefnts:array[fontnumber]of integer;
vfifnts:array[fontnumber]of fontnumber;vfnf:fontnumber;lclnf:fontnumber;
{:147}{158:}vfmove:array[stackpointer]of vfstate;
...
stackused:stackpointer;{:158}{159:}vfchartype:array[boolean]of vftype;
vfruletype:array[boolean]of vftype;{:159}{174:}widthdimen:integer;
{:174}{178:}nopt:int16;kopt:int16;scanptr:bytepointer;sepchar:ASCIIcode;
{:178}{184:}typesetting:boolean;
{:184}{186:}selectcount:array[0..9,0..9]of integer;
...
{:186}{194:}stack:array[stackindex]of stackrecord;curstack:stackrecord;
zerostack:stackrecord;stackptr:stackpointer;
{:194}{200:}{charpixels:array[charpointer]of pixvalue;hpixels:pixvalue;
vpixels:pixvalue;temppix:pixvalue;}
{:200}{221:}recurfnt:array[recurpointer]of fontnumber;
...
recurused:recurpointer;{:221}{232:}dvinum:int31;dviden:int31;
dvimag:int31;{:232}{245:}outfile:bytefile;outloc:integer;
outback:integer;outmaxv:int31;outmaxh:int31;outstack:int16u;
outpages:int16u;{:245}{256:}outfnts:array[fontnumber]of fontnumber;
outnf:fontnumber;outfnt:fontnumber;{:256}{260:}{hconv:real;vconv:real;}
{:260}{302:}termout:text;
{:302}{23:}{48:}procedure printpacket(p:pcktpointer);var k:bytepointer;
...
{:61}{182:}procedure printoptions;
begin writeln(termout,'Valid options are:');
{189:}writeln(termout,'  mag',sepchar,'<new_mag>');
writeln(termout,'  select',sepchar,'<start_count>',sepchar,
'[<max_pages>]  (up to ',10:1,' ranges)');{:189}end;
{:182}procedure closefilesandterminate;forward;procedure jumpout;
begin history:=3;closefilesandterminate;uexit(1);end;
{:23}{24:}procedure confusion(p:pcktpointer);
begin write(termout,' !This can''t happen (');printpacket(p);
writeln(termout,').');jumpout;end;
{:24}{25:}procedure overflow(p:pcktpointer;n:int16u);
begin write(termout,' !Sorry, ','ODVIcopy',' capacity exceeded [');
printpacket(p);writeln(termout,'=',n:1,'].');jumpout;end;
{:25}{95:}procedure badtfm;begin write(termout,'Bad TFM or OFM file');
...
{:296}{297:}longoptions[currentoption].name:='magnification';
longoptions[currentoption].hasarg:=1;longoptions[currentoption].flag:=0;
longoptions[currentoption].val:=0;currentoption:=currentoption+1;
{:297}{298:}longoptions[currentoption].name:='max-pages';
longoptions[currentoption].hasarg:=1;longoptions[currentoption].flag:=0;
longoptions[currentoption].val:=0;currentoption:=currentoption+1;
{:298}{299:}longoptions[currentoption].name:='page-start';
longoptions[currentoption].hasarg:=1;longoptions[currentoption].flag:=0;
longoptions[currentoption].val:=0;currentoption:=currentoption+1;
{:299}{301:}longoptions[currentoption].name:=0;
longoptions[currentoption].hasarg:=0;longoptions[currentoption].flag:=0;
longoptions[currentoption].val:=0;{:301};{188:}outmag:=0;curselect:=0;
selectmax[curselect]:=0;selected:=true;{:188};
...
printversionandexit('This is ODVIcopy, Version 1.5',
...
'odvicopy: Need at most two file arguments.');usage('odvicopy');end;end;
{:294}procedure initialize;var{16:}i:int16;{:16}{39:}h:hashcode;
{:39}begin kpsesetprogname(argv[0]);parsearguments;
write(termout,'This is ODVIcopy, Version 1.5');
...
{:73}{79:}nchars:=0;{:79}{83:}{[197:]fntspace[maxfonts]:=0;[:197]}nf:=0;
{:83}{86:}curfnt:=maxfonts;pcktmmsg:=0;pcktsmsg:=0;pcktdmsg:=0;
{:86}{119:}for i:=0 to 136 do dvipar[i]:=0;
...
{:119}{122:}for i:=0 to 136 do dvicl[i]:=0;dvicl[132]:=1;dvicl[137]:=1;
...
{:124}{127:}curcp:=0;curwp:=0;{:127}{130:}dvinf:=0;{:130}{148:}lclnf:=0;
{:148}{160:}vfmove[0][0][0]:=false;vfmove[0][0][1]:=false;
vfmove[0][1][0]:=false;vfmove[0][1][1]:=false;stackused:=0;
vfchartype[false]:=3;vfchartype[true]:=0;vfruletype[false]:=4;
vfruletype[true]:=1;{:160}{175:}widthdimen:=-1073741824;
widthdimen:=widthdimen-1073741824;{:175}{176:}nopt:=0;kopt:=0;
{:176}{185:}typesetting:=false;{:185}{195:}zerostack.hfield:=0;
zerostack.vfield:=0;for i:=0 to 1 do begin zerostack.wxfield[i]:=0;
zerostack.yzfield[i]:=0;end;{[202:]zerostack.hhfield:=0;
zerostack.vvfield:=0;[:202]}{:195}{222:}nrecur:=0;recurused:=0;
{:222}{246:}outloc:=0;outback:=-1;outmaxv:=0;outmaxh:=0;outstack:=0;
outpages:=0;{:246}{257:}outnf:=0;{:257}end;
...
if a<128 then pcktspair:=a*intcast(256)+b else pcktspair:=(a-intcast(256
))*intcast(256)+b;end;function pcktupair:int16u;var a,b:eightbits;
begin{if curloc>=curlimit then confusion(strpackets)else}
begin a:=bytemem[curloc];curloc:=curloc+1;end;
{if curloc>=curlimit then confusion(strpackets)else}
begin b:=bytemem[curloc];curloc:=curloc+1;end;
pcktupair:=a*intcast(256)+b;end;{:51}{52:}function pcktstrio:int24;
var a,b,c:eightbits;
begin{if curloc>=curlimit then confusion(strpackets)else}
begin a:=bytemem[curloc];curloc:=curloc+1;end;
{if curloc>=curlimit then confusion(strpackets)else}
...
if a<128 then pcktstrio:=(a*intcast(256)+b)*intcast(256)+c else
pcktstrio:=((a-intcast(256))*intcast(256)+b)*intcast(256)+c;end;
function pcktutrio:int24u;var a,b,c:eightbits;
begin{if curloc>=curlimit then confusion(strpackets)else}
begin a:=bytemem[curloc];curloc:=curloc+1;end;
{if curloc>=curlimit then confusion(strpackets)else}
begin b:=bytemem[curloc];curloc:=curloc+1;end;
{if curloc>=curlimit then confusion(strpackets)else}
begin c:=bytemem[curloc];curloc:=curloc+1;end;
pcktutrio:=(a*intcast(256)+b)*intcast(256)+c;end;
{:52}{53:}function pcktsquad:integer;var a,b,c,d:eightbits;
begin{if curloc>=curlimit then confusion(strpackets)else}
begin a:=bytemem[curloc];curloc:=curloc+1;end;
{if curloc>=curlimit then confusion(strpackets)else}
begin b:=bytemem[curloc];curloc:=curloc+1;end;
...
if a<128 then pcktsquad:=((a*intcast(256)+b)*intcast(256)+c)*intcast(256
)+d else pcktsquad:=(((a-intcast(256))*intcast(256)+b)*intcast(256)+c)*
intcast(256)+d;end;{:53}{54:}{procedure pcktone(x:integer);begin;
...
begin o:=dvicharcmd[upd];if ext<0 then ext:=ext+16777216;
...
{:67}{74:}function makewidth(w:integer):widthpointer;label 31;
var h:hashcode;p:widthpointer;x:int16;begin widths[nwidths]:=w;
{75:}if w>=0 then x:=w div 16777216 else begin w:=w+1073741824;
...
{:74}{87:}function findpacket:boolean;label 31,10;var p,q:pcktpointer;
f:eightbits;e:int24;begin{88:}q:=charpackets[fntchars[curfnt]+curres];
...
{:87}{89:}procedure startpacket(t:typeflag);label 31,32;
var p,q:pcktpointer;f:int8u;e:integer;curloc:bytepointer;
curlimit:bytepointer;begin{88:}q:=charpackets[fntchars[curfnt]+curres];
while q<>maxpackets do begin p:=q;q:=maxpackets;curloc:=pcktstart[p];
curlimit:=pcktstart[p+1];if p=0 then begin e:=0;f:=0;
end else begin{if curloc>=curlimit then confusion(strpackets)else}
begin f:=bytemem[curloc];curloc:=curloc+1;end;case(f div 64)of 0:e:=0;
...
byteptr:=byteptr+1;end;end;end;{:89}{90:}procedure buildpacket;
var k,l:bytepointer;
...
{:90}{98:}procedure readtfmword;begin read(tfmfile,tfmb0);
read(tfmfile,tfmb1);read(tfmfile,tfmb2);read(tfmfile,tfmb3);
if eof(tfmfile)then badfont;end;
{:98}{99:}procedure checkchecksum(c:integer;u:boolean);
...
{:99}{100:}procedure loadfont;var l,j,lprime:integer;p:charpointer;
...
{104:}z:integer;alpha:integer;beta:int15;
{:104}begin write(termout,'TFM: font ',curfnt:1);printfont(curfnt);
fnttype[curfnt]:=1;{96:}lcurname:=0;makename(tfmext);
fullname:=kpsefindtfm(curname);
if fullname then begin resetbin(tfmfile,fullname);free(curname);
free(fullname);fntextended[curfnt]:=false end else begin lcurname:=0;
makename(ofmext);fullname:=kpsefindofm(curname);
if fullname then begin resetbin(tfmfile,fullname);free(curname);
free(fullname);
fntextended[curfnt]:=true end else begin writeln(stderr,' ',
'---not loaded, TFM or OFM file can''t be opened!','.');jumpout;
end end{:96};{102:}readtfmword;
if tfmb0>127 then badfont else firsttwo:=tfmb0*intcast(256)+tfmb1;
if(firsttwo<>0)then begin ofmlevel:=-1;
if tfmb2>127 then badfont else lh:=tfmb2*intcast(256)+tfmb3;readtfmword;
if tfmb0>127 then badfont else bc:=tfmb0*intcast(256)+tfmb1;
if tfmb2>127 then badfont else ec:=tfmb2*intcast(256)+tfmb3;
if ec<bc then begin bc:=1;ec:=0;end else if ec>255 then badfont;
readtfmword;if tfmb0>127 then badfont else nw:=tfmb0*intcast(256)+tfmb1;
if(nw=0)or(nw>256)then badfont;for l:=-2 to lh do begin readtfmword;
if l=1 then begin if tfmb0<128 then w:=((tfmb0*intcast(256)+tfmb1)*
intcast(256)+tfmb2)*intcast(256)+tfmb3 else w:=(((tfmb0-intcast(256))*
intcast(256)+tfmb1)*intcast(256)+tfmb2)*intcast(256)+tfmb3;
checkchecksum(w,true);
end else if l=2 then begin if tfmb0>127 then badfont;
checkdesignsize(round(tfmconv*(((tfmb0*intcast(256)+tfmb1)*intcast(256)+
tfmb2)*intcast(256)+tfmb3)));
end end end else begin if tfmb2>127 then badfont else ofmlevel:=tfmb2*
intcast(256)+tfmb3;readtfmword;
...
nco:=(((tfmb0*256+tfmb1)*256+tfmb2)*256+tfmb3)div 2;readtfmword;
readtfmword;extrawords:=(((tfmb0*256+tfmb1)*256+tfmb2)*256+tfmb3)div 2;
...
checkdesignsize(round(tfmconv*(((tfmb0*intcast(256)+tfmb1)*intcast(256)+
tfmb2)*intcast(256)+tfmb3)));end end;
if ofmlevel>0 then for l:=1 to(nco-29-lh)do readtfmword;end{:102};
{103:}if ofmlevel<=0 then begin begin readtfmword;
if firsttwo<>0 then tfmwidth:=tfmb0 else begin if false then readtfmword
;if tfmb0>127 then badfont else tfmwidth:=tfmb0*intcast(256)+tfmb1;
end end;while(tfmwidth=0)and(bc<=ec)do begin bc:=bc+1;begin readtfmword;
if firsttwo<>0 then tfmwidth:=tfmb0 else begin if true then readtfmword;
if tfmb0>127 then badfont else tfmwidth:=tfmb0*intcast(256)+tfmb1;
end end;end;fntbc[curfnt]:=bc;fntchars[curfnt]:=nchars-bc;
...
nchars:=nchars+1;end;l:=lprime;for j:=1 to extrawords do readtfmword;
end;readtfmword;end{:103};
{106:}if nw-1>maxchars-nchars then overflow(strchars,maxchars);
if(tfmb0<>0)or(tfmb1<>0)or(tfmb2<>0)or(tfmb3<>0)then badfont else
charwidths[nchars]:=0;z:=fntscaled[curfnt];{105:}alpha:=16;
while z>=8388608 do begin z:=z div 2;alpha:=alpha+alpha;end;
beta:=256 div alpha;alpha:=alpha*z{:105};
...
charwidths[p]:=makewidth(w);end{:106};
{107:}for p:=fntchars[curfnt]+bc to nchars-1 do begin q:=charwidths[
nchars+charwidths[p]];charwidths[p]:=q;charpackets[p]:=maxpackets;
end{:107};xfclose(tfmfile,curname);
{[198:]fntspace[curfnt]:=fntscaled[curfnt]div 6;[:198]}
{write(termout,' loaded at ',fntscaled[curfnt]:1,' DVI units')};
writeln(termout,'.');end;
{:100}{108:}function definefont(load:boolean):fontnumber;
...
{:108}{113:}function dvilength:integer;
begin xfseek(dvifile,0,2,'odvicopy');dviloc:=xftell(dvifile,'odvicopy');
dvilength:=dviloc;end;procedure dvimove(n:integer);
begin xfseek(dvifile,n,0,'odvicopy');dviloc:=n;end;
{:113}{114:}function dvisbyte:int8odvicopy;var a:eightbits;
...
if a<128 then dvispair:=a*intcast(256)+b else dvispair:=(a-intcast(256))
*intcast(256)+b;end;function dviupair:int16u;var a,b:eightbits;
begin if eof(dvifile)then baddvi else read(dvifile,a);
if eof(dvifile)then baddvi else read(dvifile,b);dviloc:=dviloc+2;
dviupair:=a*intcast(256)+b;end;function dvistrio:int24;
var a,b,c:eightbits;
begin if eof(dvifile)then baddvi else read(dvifile,a);
if eof(dvifile)then baddvi else read(dvifile,b);
if eof(dvifile)then baddvi else read(dvifile,c);dviloc:=dviloc+3;
if a<128 then dvistrio:=(a*intcast(256)+b)*intcast(256)+c else dvistrio
:=((a-intcast(256))*intcast(256)+b)*intcast(256)+c;end;
function dviutrio:int24u;var a,b,c:eightbits;
begin if eof(dvifile)then baddvi else read(dvifile,a);
if eof(dvifile)then baddvi else read(dvifile,b);
if eof(dvifile)then baddvi else read(dvifile,c);dviloc:=dviloc+3;
dviutrio:=(a*intcast(256)+b)*intcast(256)+c;end;
function dvisquad:integer;var a,b,c,d:eightbits;
begin if eof(dvifile)then baddvi else read(dvifile,a);
if eof(dvifile)then baddvi else read(dvifile,b);
if eof(dvifile)then baddvi else read(dvifile,c);
if eof(dvifile)then baddvi else read(dvifile,d);dviloc:=dviloc+4;
if a<128 then dvisquad:=((a*intcast(256)+b)*intcast(256)+c)*intcast(256)
+d else dvisquad:=(((a-intcast(256))*intcast(256)+b)*intcast(256)+c)*
intcast(256)+d;end;{:114}{115:}function dviuquad:int31;var x:integer;
...
{:115}{128:}procedure dvifirstpar;begin repeat curcmd:=dviubyte;
...
if fntextended[curfnt]then begin curext:=0;
while curcmd>0 do begin curres:=curres*256+dviubyte;curcmd:=curcmd-1;
end end else while curcmd>0 do begin if curcmd=3 then if curres>127 then
curext:=-1;curext:=curext*256+curres;curres:=dviubyte;curcmd:=curcmd-1;
...
end;12:curparm:=curcmd-171;end;curclass:=dvicl[curcmd];end;
{:128}{131:}procedure dvifont;var f:fontnumber;begin{132:}f:=0;
dviefnts[dvinf]:=curparm;while curparm<>dviefnts[f]do f:=f+1{:132};
if f=dvinf then baddvi;curfnt:=dviifnts[f];
if fnttype[curfnt]=0 then loadfont;end;
{:131}{133:}procedure dvidofont(second:boolean);var f:fontnumber;
k:int15;begin write(termout,'DVI: font ',curparm:1);{132:}f:=0;
dviefnts[dvinf]:=curparm;while curparm<>dviefnts[f]do f:=f+1{:132};
...
{:133}{142:}function vfubyte:int8u;var a:eightbits;
...
vfupair:=a*intcast(256)+b;end;function vfstrio:int24;
var a,b,c:eightbits;
begin if eof(vffile)then badfont else read(vffile,a);
if eof(vffile)then badfont else read(vffile,b);
if eof(vffile)then badfont else read(vffile,c);vfloc:=vfloc+3;
if a<128 then vfstrio:=(a*intcast(256)+b)*intcast(256)+c else vfstrio:=(
(a-intcast(256))*intcast(256)+b)*intcast(256)+c;end;
function vfutrio:int24u;var a,b,c:eightbits;
begin if eof(vffile)then badfont else read(vffile,a);
if eof(vffile)then badfont else read(vffile,b);
if eof(vffile)then badfont else read(vffile,c);vfloc:=vfloc+3;
vfutrio:=(a*intcast(256)+b)*intcast(256)+c;end;function vfsquad:integer;
...
if a<128 then vfsquad:=((a*intcast(256)+b)*intcast(256)+c)*intcast(256)+
d else vfsquad:=(((a-intcast(256))*intcast(256)+b)*intcast(256)+c)*
intcast(256)+d;end;{:142}{144:}function vffix1:integer;var x:integer;
...
{:144}{145:}function vfuquad:int31;var x:integer;begin x:=vfsquad;
...
{:145}{146:}procedure vffirstpar;begin curcmd:=vfubyte;
case dvipar[curcmd]of 0:begin begin curext:=0;
if curcmd<128 then begin curres:=curcmd;
curupd:=true end else begin curres:=vfubyte;curupd:=(curcmd<133);
curcmd:=curcmd-dvicharcmd[curupd];
if fntextended[curfnt]then begin curext:=0;
while curcmd>0 do begin curres:=curres*256+vfubyte;curcmd:=curcmd-1;
end end else while curcmd>0 do begin if curcmd=3 then if curres>127 then
curext:=-1;curext:=curext*256+curres;curres:=vfubyte;curcmd:=curcmd-1;
end;end;end;curwp:=0;
...
12:curparm:=curcmd-171;end;curclass:=dvicl[curcmd];end;
{:146}{149:}procedure vffont;var f:fontnumber;begin{150:}f:=0;
vfefnts[vfnf]:=curparm;while curparm<>vfefnts[f]do f:=f+1{:150};
if f=vfnf then badfont;vfcurfnt:=vfifnts[f];end;
{:149}{151:}procedure vfdofont;var f:fontnumber;k:int31;
begin write(termout,'VF: font ',curparm:1);{150:}f:=0;
vfefnts[vfnf]:=curparm;while curparm<>vfefnts[f]do f:=f+1{:150};
...
else lclnf:=lclnf+1;vfnf:=vfnf+1;end;{:151}{152:}function dovf:boolean;
label 21,30,32,10;var tempint:integer;tempbyte:int8u;k:bytepointer;
l:int15;saveext:int24;saveres:integer;savecp:widthpointer;
savewp:widthpointer;saveupd:boolean;vfwp:widthpointer;vffnt:fontnumber;
movezero:boolean;lastpop:boolean;begin{140:}lcurname:=0;makename(vfext);
...
if fullname then begin resetbin(vffile,fullname);free(curname);
free(fullname);end else goto 32 end;vfloc:=0{:140};saveext:=curext;
saveres:=curres;savecp:=curcp;savewp:=curwp;saveupd:=curupd;
fnttype[curfnt]:=2;{153:}if vfubyte<>247 then badfont;
...
{105:}alpha:=16;while z>=8388608 do begin z:=z div 2;alpha:=alpha+alpha;
end;beta:=256 div alpha;alpha:=alpha*z{:105};begin writeln(termout);
write(termout,'   for font ',curfnt:1);end;printfont(curfnt);
writeln(termout,'.'){:153};{154:}vfifnts[0]:=maxfonts;vfnf:=0;
curcmd:=vfubyte;
...
vfdofont;curcmd:=vfubyte;end;fntfont[curfnt]:=vfifnts[0]{:154};
while curcmd<=242 do{161:}begin if curcmd<242 then begin vflimit:=curcmd
;curext:=0;curres:=vfubyte;vfwp:=checkwidth(vffix3u);
end else if fntextended[curfnt]then begin vflimit:=vfuquad;curext:=0;
curres:=vfsquad;vfwp:=checkwidth(vffix4);
...
startpacket(1);{162:}vfcurfnt:=fntfont[curfnt];vffnt:=vfcurfnt;
lastpop:=false;curclass:=3;
while true do begin 21:case curclass of 0,1,2:{165:}begin if(vfptr=0)or(
...
2:movezero:=true;end;if movezero then begin byteptr:=byteptr-1;
vfptr:=vfptr-1;end;
case curclass of 0:{166:}begin if vfcurfnt<>vffnt then begin vflast[
...
end{:166};1:{167:}begin vflast[vfptr]:=vfruletype[curupd];
...
pcktfour(curvdimen);pcktfour(curhdimen);end{:167};
2:{168:}begin vflast[vfptr]:=4;pcktunsigned(239,curparm);
if maxbytes-byteptr<curparm then overflow(strbytes,maxbytes);
while curparm>0 do begin begin bytemem[byteptr]:=vfubyte;
byteptr:=byteptr+1;end;curparm:=curparm-1;end;end{:168};end;
...
if curclass=0 then if curupd then goto 21;end;end{:165};
3:{163:}if(vfptr>0)and(vfpushloc[vfptr]=byteptr)then begin if vfpushnum[
...
{164:}begin if maxbytes-byteptr<1 then overflow(strbytes,maxbytes);
begin bytemem[byteptr]:=141;byteptr:=byteptr+1;end;end;
...
vflastend[vfptr]:=byteptr;vflast[vfptr]:=4{:164};vfpushnum[vfptr]:=0;
end{:163};4:{169:}begin if vfptr<1 then badfont;
byteptr:=vflastend[vfptr];
if vflast[vfptr]<=1 then if vflastloc[vfptr]=vfpushloc[vfptr]then{170:}
begin curclass:=vflast[vfptr];curupd:=false;byteptr:=vfpushloc[vfptr];
end{:170};
if byteptr=vfpushloc[vfptr]then{171:}begin if vfpushnum[vfptr]>0 then
...
end{:171}else begin if vflast[vfptr]=2 then{172:}begin byteptr:=byteptr
-2;for k:=vflastloc[vfptr]+1 to byteptr do bytemem[k-1]:=bytemem[k];
vflast[vfptr]:=4;vflastend[vfptr]:=byteptr;end{:172};
begin if maxbytes-byteptr<1 then overflow(strbytes,maxbytes);
...
if vfpushnum[vfptr+1]>0 then{173:}begin vfptr:=vfptr+1;
{164:}begin if maxbytes-byteptr<1 then overflow(strbytes,maxbytes);
begin bytemem[byteptr]:=141;byteptr:=byteptr+1;end;end;
begin vfmove[vfptr][0][0]:=vfmove[vfptr-1][0][0];
vfmove[vfptr][0][1]:=vfmove[vfptr-1][0][1];
vfmove[vfptr][1][0]:=vfmove[vfptr-1][1][0];
vfmove[vfptr][1][1]:=vfmove[vfptr-1][1][1]end;vfpushloc[vfptr]:=byteptr;
vflastend[vfptr]:=byteptr;vflast[vfptr]:=4{:164};
vfpushnum[vfptr]:=vfpushnum[vfptr]-1;end{:173};end;end{:169};
...
30:if(vfptr<>0)or(vfloc<>vflimit)then badfont{:162};
k:=pcktstart[pcktptr];
...
pcktres)then byteptr:=k;end;buildpacket;curcmd:=vfubyte;end{:161};
...
goto 10;32:dovf:=false;10:end;{:152}{181:}{177:}procedure inputln;
...
{:177}{179:}function scankeyword(p:pcktpointer;l:int7):boolean;
...
{:179}{180:}function scanint:integer;var x:integer;negative:boolean;
...
if curselect=0 then selected:=false;end;end;{:190}procedure dialog;
label 10;var p:pcktpointer;begin{188:}outmag:=0;curselect:=0;
selectmax[curselect]:=0;selected:=true;
{:188}while true do begin inputln;p:=newpacket;bytemem[byteptr]:=32;
scanptr:=pcktstart[pcktptr-1];
while((bytemem[scanptr]=32)or(bytemem[scanptr]=47))and(scanptr<byteptr)
do scanptr:=scanptr+1;if scanptr=byteptr then begin flushpacket;goto 10;
end{191:}else if scankeyword(strmag,3)then outmag:=scanint else if
...
end{:191}else begin if nopt=0 then sepchar:=' 'else sepchar:=xchr[47];
printoptions;
...
end;{:252}{253:}procedure outchar(upd:boolean;ext:integer;res:integer);
...
{:253}{254:}procedure outunsigned(o:eightbits;x:integer);begin;
if(x<256)and(x>=0)then if(o=235)and(x<64)then x:=x+171 else begin
...
{:254}{255:}procedure outsigned(o:eightbits;x:integer);var xx:int31;
...
begin putbyte(x div 256,outfile);outloc:=outloc+1;end;x:=x mod 256;end;
begin putbyte(x,outfile);outloc:=outloc+1;end;end;
{:255}{259:}procedure outfntdef(f:fontnumber);var p:pcktpointer;
...
{:259}{:183}{187:}function startmatch:boolean;var k:0..9;match:boolean;
begin match:=true;
...
end;{:187}{205:}procedure dopre;{261:}var k:int15;p,q,r:bytepointer;
comment:^char;{:261}begin alldone:=false;numselect:=curselect;
...
outloc:=outloc+1;end;{:262}end;{:205}{206:}procedure dobop;
{263:}var{:263}i,j:0..9;
begin{207:}if not selected then selected:=startmatch;
typesetting:=selected{:207};write(termout,'DVI: ');
...
curfnt:=maxfonts;{264:}begin putbyte(139,outfile);outloc:=outloc+1;end;
outpages:=outpages+1;for i:=0 to 9 do outfour(count[i]);
outfour(outback);outback:=outloc-45;outfnt:=maxfonts;{:264}end;end;
{:206}{208:}procedure doeop;
{265:}{:265}begin if stackptr<>0 then baddvi;
{266:}begin putbyte(140,outfile);outloc:=outloc+1;end;
{:266}if selectmax[curselect]>0 then begin selectmax[curselect]:=
...
end;typesetting:=false;end;{:208}{209:}procedure dopush;
{267:}{:267}begin if stackptr=stackused then if stackused=stacksize then
overflow(strstack,stacksize)else stackused:=stackused+1;
stackptr:=stackptr+1;stack[stackptr]:=curstack;
{268:}if stackptr>outstack then outstack:=stackptr;
begin putbyte(141,outfile);outloc:=outloc+1;end;{:268}end;
procedure dopop;{269:}{:269}begin if stackptr=0 then baddvi;
curstack:=stack[stackptr];stackptr:=stackptr-1;
{270:}begin putbyte(142,outfile);outloc:=outloc+1;end;{:270}end;
{:209}{210:}procedure doxxx;{271:}var{:271}p:pcktpointer;
begin p:=newpacket;{272:}outunsigned(239,(pcktstart[p+1]-pcktstart[p]));
outpacket(p);{:272}flushpacket;end;{:210}{211:}procedure doright;
{273:}{:273}begin if curclass>=8 then curstack.wxfield[curclass-8]:=
curparm else if curclass<7 then curparm:=curstack.wxfield[curclass-5];
{274:}if curclass<7 then begin putbyte(curcmd,outfile);outloc:=outloc+1;
end else outsigned(dvirightcmd[curclass],curparm);
{:274}curstack.hfield:=curstack.hfield+curparm{;
...
{275:}if abs(curstack.hfield)>outmaxh then outmaxh:=abs(curstack.hfield)
;{:275}end;{:211}{212:}procedure dodown;
{276:}{:276}begin if curclass>=13 then curstack.yzfield[curclass-13]:=
curparm else if curclass<12 then curparm:=curstack.yzfield[curclass-10];
{277:}if curclass<12 then begin putbyte(curcmd,outfile);
outloc:=outloc+1;end else outsigned(dvidowncmd[curclass],curparm);
{:277}curstack.vfield:=curstack.vfield+curparm{;
...
{278:}if abs(curstack.vfield)>outmaxv then outmaxv:=abs(curstack.vfield)
;{:278}end;{:212}{213:}procedure dowidth;
{279:}{:279}begin{280:}begin putbyte(132,outfile);outloc:=outloc+1;end;
outfour(widthdimen);outfour(curhdimen);
{:280}curstack.hfield:=curstack.hfield+curhdimen{;
begin curstack.hhfield:=curstack.hhfield+hpixels;
temppix:=round(hconv*(curstack.hfield));
if abs(temppix-curstack.hhfield)>2 then if temppix>curstack.hhfield then
curstack.hhfield:=temppix-2 else curstack.hhfield:=temppix+2;end};
{275:}if abs(curstack.hfield)>outmaxh then outmaxh:=abs(curstack.hfield)
;{:275}end;{:213}{214:}procedure dorule;{281:}var{:281}visible:boolean;
...
{282:}begin putbyte(dvirulecmd[curupd],outfile);outloc:=outloc+1;end;
outfour(curvdimen);outfour(curhdimen);
{:282}end else begin visible:=false;
{283:}{282:}begin putbyte(dvirulecmd[curupd],outfile);outloc:=outloc+1;
end;outfour(curvdimen);outfour(curhdimen);{:282}{:283}end;
...
curstack.hhfield:=temppix-2 else curstack.hhfield:=temppix+2;end};
{275:}if abs(curstack.hfield)>outmaxh then outmaxh:=abs(curstack.hfield)
;{:275}end;end;{:214}{215:}procedure dochar;
{288:}{:288}begin{289:}{if fnttype[curfnt]<>3 then confusion(strfonts);}
if curfnt<>outfnt then begin outunsigned(235,fntfont[curfnt]);
outfnt:=curfnt;end;outchar(curupd,curext,curres);
{:289}if curupd then begin curstack.hfield:=curstack.hfield+widths[curwp
]{;begin curstack.hhfield:=curstack.hhfield+charpixels[curcp];
temppix:=round(hconv*(curstack.hfield));
if abs(temppix-curstack.hhfield)>2 then if temppix>curstack.hhfield then
curstack.hhfield:=temppix-2 else curstack.hhfield:=temppix+2;end};
{275:}if abs(curstack.hfield)>outmaxh then outmaxh:=abs(curstack.hfield)
;{:275}end;end;{:215}{217:}procedure dofont;label 30;
{284:}var{:284}p:charpointer;
begin{if fnttype[curfnt]=0 then confusion(strfonts);}
{for p:=fntchars[curfnt]+fntbc[curfnt]to fntchars[curfnt]+fntec[curfnt]
do charpixels[p]:=round(hconv*(widths[charwidths[p]]));}
{285:}{:285}if dovf then goto 30;
{286:}if(outnf>=maxfonts)then overflow(strfonts,maxfonts);
...
{:286}30:{if fnttype[curfnt]<=1 then confusion(strfonts);}end;
{:217}{219:}procedure pcktfirstpar;begin curcmd:=pcktubyte;
case dvipar[curcmd]of 0:begin curext:=0;
if curcmd<128 then begin curres:=curcmd;
curupd:=true end else begin curres:=pcktubyte;curupd:=(curcmd<133);
curcmd:=curcmd-dvicharcmd[curupd];
if fntextended[curfnt]then begin curext:=0;
while curcmd>0 do begin curres:=curres*256+pcktubyte;curcmd:=curcmd-1;
end end else while curcmd>0 do begin if curcmd=3 then if curres>127 then
curext:=-1;curext:=curext*256+curres;curres:=pcktubyte;curcmd:=curcmd-1;
...
{:219}{223:}procedure dovfpacket;label 22,31,30;var k:recurpointer;
f:int8u;saveupd:boolean;savecp:widthpointer;savewp:widthpointer;
savelimit:bytepointer;begin{224:}saveupd:=curupd;savecp:=curcp;
savewp:=curwp;recurfnt[nrecur]:=curfnt;recurext[nrecur]:=curext;
recurres[nrecur]:=curres{:224};
{226:}if findpacket then f:=curtype else goto 30;
...
31:case curclass of 0:{227:}begin{218:}{287:}{:287}if fnttype[curfnt]<=1
then dofont{:218};curcp:=fntchars[curfnt]+curres;
curwp:=charwidths[curcp];
if(curloc=curlimit)and(f=0)and saveupd then begin saveupd:=false;
curupd:=true;end;
if fnttype[curfnt]=2 then{228:}begin recurloc[nrecur]:=curloc;
if curloc<curlimit then if bytemem[curloc]=142 then curupd:=false;
if nrecur=recurused then if recurused=maxrecursion then{229:}begin
...
end{:229}else recurused:=recurused+1;nrecur:=nrecur+1;dovfpacket;
nrecur:=nrecur-1;curloc:=recurloc[nrecur];curlimit:=savelimit;
end{:228}else dochar;end{:227};1:dorule;
...
30:{:226}if saveupd then begin curhdimen:=widths[savewp];
begin{hpixels:=charpixels[savecp];}dowidth;end;end;
{225:}curfnt:=recurfnt[nrecur]{:225};end;{:223}{230:}procedure dodvi;
label 30,10;var tempbyte:int8u;tempint:integer;dvistart:integer;
dviboppost:integer;dviback:integer;k:int15;
begin{231:}if dviubyte<>247 then baddvi;if dviubyte<>2 then baddvi;
...
writeln(termout,'.');dopre;flushpacket{:231};
if true then{233:}begin dvistart:=dviloc;{234:}tempint:=dvilength-5;
...
dvimove(dviboppost);if dviubyte<>248 then baddvi{:234};
...
if not selected then{235:}begin dvistart:=dviboppost;
...
end{:235};dvimove(dvistart);end{:233};repeat dvifirstpar;
while curclass=16 do begin dvidofont(true);dvifirstpar;end;
if curcmd=139 then{236:}begin for k:=0 to 9 do count[k]:=dvisquad;
tempint:=dvipointer;dobop;dvifirstpar;
if typesetting then{237:}while true do begin case curclass of 0:{239:}
begin{218:}{287:}{:287}if fnttype[curfnt]<=1 then dofont{:218};curwp:=0;
...
if fnttype[curfnt]=2 then dovfpacket else dochar;end{:239};
...
16:dvidofont(true);17:goto 30;end;dvifirstpar;
end{:237}else{238:}while true do begin case curclass of 2:while curparm>
0 do begin tempbyte:=dviubyte;curparm:=curparm-1;end;16:dvidofont(true);
17:goto 30;others:;end;dvifirstpar;end{:238};
30:if curcmd<>140 then baddvi;if selected then begin doeop;
if alldone then goto 10;end;end{:236};until curcmd<>140;
if curcmd<>248 then baddvi;10:end;
{:230}{241:}procedure closefilesandterminate;var k:int15;begin;
if history<3 then{216:}begin if typesetting then{290:}begin while
...
{291:}if outloc>0 then begin{292:}begin putbyte(248,outfile);
...
begin putbyte(2,outfile);outloc:=outloc+1;end{:292};
...
if outpages=0 then if history=0 then history:=1;{:291}end{:216};
{[243:]writeln(termout,'Memory usage statistics:');
write(termout,dvinf:1,' dvi, ',lclnf:1,' local, ');
[258:]write(termout,outnf:1,' out, ');
[:258]writeln(termout,'and ',nf:1,' internal fonts of ',maxfonts:1);
...
[293:][:293]writeln(termout,stackused:1,' of ',stacksize:1,' stack and '
,recurused:1,' of ',maxrecursion:1,' recursion levels.')[:243];}
{248:}{:248}{244:}case history of 0:writeln(termout,
...
;3:writeln(termout,'(That was a fatal error, my friend.)');end{:244};
end;{:241}{242:}begin initialize;
...
{:45}{92:}{if maxbytes-byteptr<4 then overflow(strbytes,maxbytes);}
...
{:92}{136:}{if maxbytes-byteptr<3 then overflow(strbytes,maxbytes);}
...
{:136}{192:}{if maxbytes-byteptr<3 then overflow(strbytes,maxbytes);}
...
bytemem[byteptr-1]:=116;strselect:=makepacket;{:192}{111:}dviloc:=0;
{:111}{247:}{:247}dodvi;closefilesandterminate;end.{:242}
