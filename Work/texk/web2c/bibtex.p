...
label 9998,9999{110:},31{:110}{147:},32,9932{:147};
const{14:}hashprime=30011;hashsize=35307;hashbase=1;
hashmax=hashbase+hashsize-1;hashmaxp1=hashmax+1;
maxhashvalue=hashprime+hashprime+125;quotenextfn=hashbase-1;
endofdef=hashmax+1;undefined=hashmax+1;BUFSIZE=20000;minprintline=3;
...
MAXFIELDS=5000;litstksize=100;{:14}{334:}numbltinfns=37;
{:334}type{22:}ASCIIcode=0..255;{:22}{31:}lextype=0..5;idtype=0..1;
{:31}{36:}alphafile=packed file of ASCIIcode;
{:36}{43:}bufpointer=integer;buftype=^ASCIIcode;
{:43}{50:}poolpointer=integer;strnumber=0..maxstrings;
{:50}{65:}hashloc=hashbase..hashmax;hashpointer=0..hashmax;strilk=0..14;
{:65}{74:}pdsloc=1..12;pdslen=0..12;pdstype=packed array[pdsloc]of char;
{:74}{106:}auxnumber=0..auxstacksize;{:106}{119:}bibnumber=integer;
{:119}{131:}citenumber=0..maxcites;{:131}{161:}fnclass=0..8;
wizfnloc=integer;intentloc=integer;strentloc=integer;strglobloc=0..19;
fieldloc=integer;hashptr2=quotenextfn..endofdef;
{:161}{292:}litstkloc=0..litstksize;stktype=0..4;
{:292}{333:}bltinrange=0..numbltinfns;
{:333}var{2:}standardinput,standardoutput:text;
{:2}{16:}maxentints:integer;maxentstrs:integer;poolsize:integer;
maxbibfiles:integer;wizfnspace:integer;maxfields:integer;bad:integer;
{:16}{19:}history:0..3;errcount:integer;
{:19}{24:}xord:array[ASCIIcode]of ASCIIcode;
...
{:49}{66:}hashnext:packed array[hashloc]of hashpointer;
...
{:75}{77:}predefloc:hashloc;{:77}{79:}commandnum:integer;
{:79}{81:}bufptr1:bufpointer;bufptr2:bufpointer;
{:81}{90:}scanresult:0..3;{:90}{92:}tokenvalue:integer;
{:92}{98:}auxnamelength:integer;
...
bstfile:alphafile;
{:125}{130:}citelist:packed array[citenumber]of strnumber;
...
allentries:boolean;allmarker:citenumber;{:130}{148:}bbllinenum:integer;
bstlinenum:integer;{:148}{162:}fnloc:hashloc;wizloc:hashloc;
...
{:220}{248:}bibbracelevel:integer;
{:248}{291:}litstack:array[litstkloc]of integer;
...
markfatal;end;{:46}{47:}procedure bufferoverflow;var cursize:integer;
begin cursize:=bufsize;
BIBXRETALLOC('buffer',buffer,ASCIIcode,cursize,cursize+BUFSIZE);
cursize:=bufsize;
BIBXRETALLOC('sv_buffer',svbuffer,ASCIIcode,cursize,cursize+BUFSIZE);
cursize:=bufsize;
BIBXRETALLOC('ex_buf',exbuf,ASCIIcode,cursize,cursize+BUFSIZE);
cursize:=bufsize;
BIBXRETALLOC('out_buf',outbuf,ASCIIcode,cursize,cursize+BUFSIZE);
cursize:=bufsize;
BIBXRETALLOC('name_tok',nametok,bufpointer,cursize,cursize+BUFSIZE);
cursize:=bufsize;
BIBXRETALLOC('name_sep_char',namesepchar,ASCIIcode,cursize,cursize+
BUFSIZE);bufsize:=cursize;end;
...
{:170}{189:}procedure singlfnoverflow;begin begin printoverflow;
...
filename])+1);pptr:=strstart[filename];
...
nameoffile[namelength+1]:=0;end;
{:61}{62:}procedure addarea(area:strnumber);var pptr:poolpointer;
...
{:62}{55:}function makestring:strnumber;
...
hashfound:=false;oldstring:=false;
...
var i:pdslen;begin for i:=1 to len do buffer[i]:=xord[pds[i-1]];
...
if(singleptr=singlefnspace)then singlfnoverflow;singleptr:=singleptr+1;
end;bufptr2:=bufptr2+1;scanfndef(implfnloc);end{:195};
others:{200:}begin if(scan2white(125,37))then;
...
goto 9998;end;litstkptr:=litstkptr+1;end;
...
if(outbufptr=minprintline-1)then{325:}begin if outbuf[maxprintline-1]=37
then outbuflength:=maxprintline-1 else outbuflength:=maxprintline;
breakptr:=outbuflength-1;outbuf[endptr]:=outbuf[breakptr];
outbuf[breakptr]:=37;outputbblline;outbuf[breakptr]:=outbuf[endptr];
outbufptr:=0;tmpptr:=breakptr;
...
end{:325}else begin outbuflength:=outbufptr;breakptr:=outbuflength+1;
...
others:{363:}begin if(poplit1<cmdstrptr)then begin begin if(poolptr+(
...
begin{103:}kpsesetprogname(argv[0]);parsearguments;
...
{124:}begin if(bibptr=maxbibfiles)then begin BIBXRETALLOC('bib_list',
...
1:{243:}begin if(preambleptr=maxbibfiles)then begin BIBXRETALLOC(
...
{288:}begin if(numentints*numcites>maxentints)then BIBXRETALLOC(
'entry_ints',entryints,integer,maxentints,(numentints+1)*(numcites+1));
intentptr:=0;
while(intentptr<numentints*numcites)do begin entryints[intentptr]:=0;
intentptr:=intentptr+1;end;end{:288};
{289:}begin if(numentstrs*numcites>maxentstrs)then begin BIBXRETALLOC(
...
{:155}{:218}{:12}{13:}procedure initialize;var{23:}i:integer;
{:23}{67:}k:hashloc;{:67}begin{17:}bad:=0;if(minprintline<3)then bad:=1;
...
bufsize:=BUFSIZE;maxbibfiles:=MAXBIBFILES;maxfields:=MAXFIELDS;
wizfnspace:=WIZFNSPACE;bibfile:=XTALLOC(maxbibfiles+1,alphafile);
...
namesepchar:=XTALLOC(bufsize+1,ASCIIcode);initialize;hack0;
...
end else begin begin write(logfile,'This is BibTeX, Version 0.99c');end;
