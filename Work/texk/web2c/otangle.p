{2:}{4:}{$C-,A+,D-}{[$C+,D+]}
{:4}program OTANGLE(webfile,changefile,Pascalfile,pool);label 9999;
...
{:185}{192:}webname,chgname,pascalname,poolname:cstring;
...
'otangle: Need one or two file arguments.');usage('otangle');end;
...
if chgname then reset(changefile,chgname);end;
