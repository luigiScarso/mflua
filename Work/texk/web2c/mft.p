...
outline:integer;{:88}{117:}changename,texname:cstring;
stylename:array[0..31]of cstring;nstylename:cinttype;
...
suffix:cstring;begin{124:}metapost:=false;{:124};{119:}currentoption:=0;
...
'mft: Need exactly one file argument.');usage('mft');end;
...
{:56}begin kpsesetprogramname(argv[0],nil);parsearguments;
