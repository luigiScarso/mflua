...
maxrow=100000;{:6}type{9:}ASCIIcode=32..126;
...
{:92}{95:}gfname,pkname,vplname:cstring;
...
'gftopk: Need one or two file arguments.');usage('gftopk');end;
...
{:42}{50:}for i:=0 to 255 do status[i]:=0;{:50}{80:}power[0]:=1;
...
{61:}gflen:=gflength;postloc:=gflen-4;
...
{58:}begin bad:=false;rowptr:=2;on:=false;extra:=0;state:=true;
