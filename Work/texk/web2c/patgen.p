{3:}{11:}{$C-,A+,D-}
{:11}program PATGEN(dictionary,patterns,translate,patout);label 9999;
...
until getoptreturnval=-1;if(optind+4<>argc)then begin writeln(stderr,
'patgen: Need exactly four arguments.');usage('patgen');end;end;
{:98}procedure initialize;var{15:}bad:integer;i:textchar;j:ASCIIcode;
{:15}begin kpsesetprogname(argv[0]);parsearguments;
