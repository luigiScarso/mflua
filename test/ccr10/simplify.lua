...
local function simplifyBsB (cycle,threshold_simplify_n,char_index)
   --
   -- Big small 
   -- 
   print("BEZ simplify")
...
local function simplify (cycle,threshold_simplify_n,char_index)
   print("BEZ simplify")
   local valid_curves ={}
   local curve_length = {}
   local mflua_exe = mflua.mflua_exe
...
for _,cycle in pairs(cycles) do
   ...
   local cycle1 = simplify (cycle,mflua.threshold_simplify_n,char_index )
   local cycle2 = simplifyBsB (cycle1,mflua.threshold_simplify_n,char_index )
   local cyclen = cycle2;
